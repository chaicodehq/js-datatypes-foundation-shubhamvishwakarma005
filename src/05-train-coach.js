...
export function findPassenger(passengers, name) {
  ...
  return passengers.find(psg=> psg.name.toLowerCase() === name.toLowerCase())
}
...
export function getPassengerIndex(passengers, name) {
  ...
  return passengers.findIndex(psg => psg.name.toLowerCase() === name.toLowerCase())
}
...
export function isAnyWaitlisted(passengers) {
  ...
  return passengers.some(psg => psg.status === "waitlisted")
}
...
export function areAllConfirmed(passengers) {
  ...
  return passengers.every(psg => psg.status === "confirmed")
}
...
export function getWaitlistedPassengers(passengers) {
  ...
  return passengers.filter(psg => psg.status === "waitlisted")
